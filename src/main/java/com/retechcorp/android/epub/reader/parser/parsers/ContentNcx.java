...
import com.retechcorp.android.epub.reader.parser.beans.xml.NcxDirectory;
 ...
 * ncx文件解析
 */
public class ContentNcx extends ADocument {

    private NcxDirectory ncxDirectory;

    public ContentNcx(String documentPath) throws Exception {
        super(documentPath);
    }
            ...
            while (eventType != XmlPullParser.END_DOCUMENT) {
                ...
                switch (eventType) {
                    ...
                    case XmlPullParser.START_TAG:
                        if (NCX_LABEL_NCX.equals(nodeName)) {
                            //package 的开始节点
                            this.ncxDirectory = new NcxDirectory(xmlPullParser);
                        }
                        break;
                    //结束节点
    ...
    public NcxDirectory getNcxDirectory() {
        return ncxDirectory;
    }
}
