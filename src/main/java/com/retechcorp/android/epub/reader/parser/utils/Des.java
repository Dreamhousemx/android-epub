...
public class Des {
    ...
    private static final String getTelephonyID() {
        SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        // SimpleDateFormat.getDateInstance().getTimeZone();
        ...
        telephonyManager = (TelephonyManager) EpubReaderActivity.activity.getSystemService(EpubReaderActivity.activity.TELEPHONY_SERVICE);
        /**
    ...
    public static void test() {
        // TODO 秘钥创建
        Des de = new Des("1991101119911011");
        System.out.println("加密：" + de.encrypt("没有岩石的阻挡，怎能激起美丽的浪花！"));
        System.out.println("解密：" + de.decrypt("Fz6GSTU2Ma2e96eyomZJJa2qVKpIot4bXC6IPgnBWDRxfCKQaGK-vIK5ssCxv7Z5"));
